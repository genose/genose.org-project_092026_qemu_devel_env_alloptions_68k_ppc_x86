...
FAIL=0
TOTAL=0
SKIP_PATTERNS=("common.sh" "generate_wrapper.sh" "gui_scripts_menu.sh" "test_all_scripts.sh" "debug_vm_xdialog.sh" "platform_select_xdialog.sh" "vm_create_xdialog.sh" "vm_create_gui.sh" "vm_manage_xdialog.sh" "config_management_xdialog.sh")
